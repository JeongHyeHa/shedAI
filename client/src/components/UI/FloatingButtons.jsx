...
function FloatingButtons({ onClickPlus, onClickPencil, onClickAdvice, onClickReport }) {
  return (
    <div className="floating-buttons">
      <button className="float-btn" onClick={onClickReport}><img src={smileIcon} alt="Report" /></button>
