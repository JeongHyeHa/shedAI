...
3. **생활 패턴 반복 배치 규칙 (매우 중요):**
   ...
   **생활 패턴 반복 배치 규칙:**
   ...
   - **"평일" 패턴**: 생성 기간의 모든 평일(day:1,2,3,4,5)에 모두 반복 배치
     * 예: "평일 오전 8시~오후 5시 출근" → 생성 기간의 모든 평일에 출근 배치
   - **"주말" 패턴**: 생성 기간의 모든 주말(day:6,7)에 모두 반복 배치
     * 예: "주말 22시~24시 자유 시간" → 생성 기간의 모든 주말(day:6, day:7)에 자유 시간 배치
